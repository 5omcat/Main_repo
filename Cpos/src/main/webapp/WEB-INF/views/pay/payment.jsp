...
<section class="py-0 scrollspy" style="background-color: 007bff;">
  <!-- 처음row -->
   <div class="row">
      ...
      <div class="container col-4 scrollspy" style="height: 760px;overflow: auto; display:inline-block; text-align:center;">
      ...
      style="display: inline-block;text-align: center; height: 760px;overflow: auto; padding:0px; background-color: #F2F2F2;">
         <table class="table">
            <thead>
               <tr class="table-primary">
                  <th style="display: none">ino</th>
   ...
   <!-- 두번째 row -->
   <div class="row">
      <div class="col-sm-2" style="background-color: #46aaff;">
         <span></span>
      </div>
      <div class="col-sm-4">
            <span></span>
       </div>
       <div class="col-sm-1" style="background-color: #F2F2F2;">
            <span></span>
       </div>
      <div class="col-sm-5" style="background-color: #F2F2F2; height:50px;">
   ...
   $(function() {
      ...
      /* 쇼핑리스트 항목 삭제 */
        $(document).on("click", "button[name='del']", function(){
            ...
            let pname = $(this).closest("ul").find("li:nth-child(4)").text();
